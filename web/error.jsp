...
<%--CSS 样式解释--%>
<%--body: 设置了全局字体样式和页面边距。--%>
<%--.body404: 设置了页面背景样式和尺寸。--%>
<%--.site-name404: 页面顶部标题样式，使用渐变色填充文本。--%>
<%--.title404: 错误信息的标题样式，设置字体大小和颜色。--%>
<%--.info404: 包裹错误信息和返回按钮的容器，垂直居中显示。--%>
<%--.index404: 返回按钮的样式，定义了按钮的外观、边框、圆角和颜色。--%>
<%--.icon-about: 图标的样式，用于设置链接的外观。--%>
<%--@-webkit-keyframes hue: 使用Webkit动画定义了文字渐变效果。--%>
